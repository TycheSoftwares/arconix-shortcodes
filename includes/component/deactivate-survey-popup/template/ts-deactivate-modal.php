    ...
    ( function ($) {
        ...
        function registerEventHandlers() {
            ...
            $modal.on('click', 'input[type="radio"]', function () {
                ...
                $modal.find('.button-deactivate').text('<?php printf( Shortcodes_TS_deactivate::load_str( 'deactivation-modal-button-submit' ) ); ?>');
        ...
        function updateButtonLabels() {
            ...
            if ('confirm' === getCurrentPanel()) {
                $deactivateButton.text('<?php printf( Shortcodes_TS_deactivate::load_str( 'deactivation-modal-button-confirm' ) ); ?>');
            } else {
                var $radio = $('input[type="radio"]:checked');
                if( $radio.length == 0 ) {
                    $deactivateButton.text('<?php printf( Shortcodes_TS_deactivate::load_str( 'deactivation-modal-button-deactivate' ) ); ?>');
                } else {
